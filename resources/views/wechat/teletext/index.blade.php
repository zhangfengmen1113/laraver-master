                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="nav nav-tabs nav-overflow header-tabs">
                            <li class="nav-item">
                                <a href="{{route('wechat.teletext.index')}}" class="nav-link active">
                                    回复列表
                                </a>

                            </li>
                            <li class="nav-item">
                                <a href="{{route('wechat.teletext.create')}}" class="nav-link ">
                                    添加图文回复
                                </a>
                            </li>
                        </ul>
        ...
        <div class="card">
            <div class="table-responsive mb-0" data-toggle="lists"
                ...
                <table class="table table-sm table-nowrap card-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" role="group" aria-label="First group">
                                    ...
                                    <a href="{{route('wechat.teletext.edit',$v)}}" class="btn btn-white">编辑</a>

                                    <button onclick="del(this)" type="button" class="btn btn-white">删除</button>
                                    <form action="{{route('wechat.teletext.destroy',$v)}}" method="post">
                                        @csrf  @method('DELETE')
                                    </form>
                                </div>
                            </td>
                    ...
                    @else
                       <tr>
                           <td class="text-center text-muted" rowspan="5" colspan="5"><p>暂无图文回复</p></td>
                       </tr>
                    @endif
                    </tbody>
                </table>
