                    ...
                    <div class="col-4">
                        <div class="mobile">
                            <div class="mobile-container">
                                <dl style="cursor: pointer" v-for="(v,k) in menus.button">
                                    <dt @click="editCurrentMenu(v)">
                                        @{{v.name}}
                                        <span @click.stop="delTopMenu(k)" class="fe fe-minus-square"></span>
                                    </dt>
                                    <dd v-for="(m,n) in v.sub_button">
                                        @{{m.name}}
                                        <span @click.stop="delSubMenu(v,n)" @click="editCurrentMenu(m)" class="fe fe-minus-square"></span>
                                    </dd>
                                    <dd @click="addSubMenu(v)" v-if="v.sub_button.length < 5">
                                        <span class="fe fe-plus-square"></span>
                                    </dd>
                                </dl>
                                <dl style="cursor: pointer" v-if="menus.button.length < 3">
                                    <dt @click="addTopMenu">
                                        <span class="fe fe-plus-square"></span>
                                    </dt>
                                </dl>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline" >
                                                        <input class="form-check-input" type="radio" v-model="currentMenu.type" value="type" name="inlineRadioOptions" id="inlineRadio2">
                                                ...
                                                <div class="form-group" v-if="currentMenu.type == 'type'">
                ...
                methods: {
                    ...
                    addTopMenu(){
                        ...
                        if (this.menus.button.length < 3){
                            // 定义个变量
                            var html = {type: 'click',name:'猪猪男孩',key:'',sub_button:[]}
                            //console.log(html);
                            //当点击本身这个按钮时候就添加一个html里面的数据
                    ...
                    addSubMenu(v){
                        ...
                        if (v.sub_button.length < 5){
                            // 定义个变量
                            var html = {type: 'click',name:'猪猪男孩',key:''};
                            //console.log(html);
                            //当点击本身这个按钮时候就添加一个html里面的数据
