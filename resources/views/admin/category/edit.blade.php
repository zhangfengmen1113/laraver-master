                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('admin.category.update',$category)}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="author" value="{{$category['author']}}" class="form-control" id="exampleInputPassword1">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" value="{{$category['icon']}}" name="icon" aria-label="Amount (to the nearest dollar)">
