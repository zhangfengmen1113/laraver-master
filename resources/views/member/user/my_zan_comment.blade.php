                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <ul class="nav nav-tabs nav-overflow header-tabs">
                                    <li class="nav-item">
                                        <a href="{{route('member.my.like',[$user,'type'=>'article'])}}" class="nav-link ">
                                            文章
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('member.my.like',[$user,'type'=>'comment'])}}" class="nav-link active">
                                            评论
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card" data-toggle="lists" data-lists-values="[&quot;name&quot;]">
                                ...
                                <div class="card-body">
                                   ...
                                   @else
                                        <p class="text-muted text-center p-5">暂无好文章评论</p>
                                   @endif
                                </div>
                            </div>
